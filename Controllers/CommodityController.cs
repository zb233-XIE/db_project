...
namespace TJ_Games.Controllers
{
    public class CommodityController : Controller
    {
        ...
        [HttpPost]
        public IActionResult AddToCart([FromBody] string UserID,string CommodityID)
        {
        ...
        public IActionResult AddToWishList([FromBody] string UserID, string CommodityID)
        {
            JsonData jsondata = new JsonData();
        ...
        public IActionResult DeleteWishList([FromBody] string UserID, string CommodityID)
        {
            JsonData jsondata = new JsonData();
